...
public class MainForm extends javax.swing.JFrame {
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSend]: Hủy bỏ "+ username);
                } catch (IOException e) {
                    appendMessage("[FileSend]: "+ e.getMessage());
                    appendMessage("[FileSend]: Không thể hủy bỏ "+ username);
                }
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SERVER CHAT ROOM");
...
// onclick khởi động máy chủ thì sẽ tạo ra new thread
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int port = Integer.parseInt(jTextField1.getText());// khởi động server
